...
namespace Common
{
    public class SerilogTraceListener : TraceListener, ISupportFilters
    {
        #region const
        ...
        public override void Write(object o)
        {
            ...
            {
                sbMessages.Remove(sbMessages.Length - 2, 2);
                _logger.Write(Serilog.Events.LogEventLevel.Debug, sbMessages.ToString());
    ...
    public class DelayedSerilogTraceListener : TraceListenerDelayItems, ISupportFilters
    {
        public DelayedSerilogTraceListener() : base()
        {
            TraceListener innerListener = new SerilogTraceListener();
