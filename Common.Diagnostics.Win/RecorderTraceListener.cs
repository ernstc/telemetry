...
namespace Common
{
    public class RecorderTraceListener : TraceListener, ISupportFilters
    {
        #region const
        ...
        ConcurrentQueue<TraceEntry> TraceEntries = new ConcurrentQueue<TraceEntry>();
        #endregion

        #region .ctor
        public RecorderTraceListener() { Init(); }
        // Summary: Initializes a new instance of the EkipCommon.RecorderTraceListener class that writes to the specified output stream.
        // Parameters:  stream: The System.IO.Stream to receive the output.
        // Exceptions:  T:System.ArgumentNullException: stream is null.
        public RecorderTraceListener(Stream stream) : base() { Init(); }

        // Summary: Initializes a new instance of the EkipCommon.RecorderTraceListener class that writes to the specified text writer.
        // Parameters:  writer: The System.IO.TextWriter to receive the output.
        // Exceptions:  T:System.ArgumentNullException: writer is null.
        public RecorderTraceListener(TextWriter writer) { Init(); }
        // Summary: Initializes a new instance of the EkipCommon.RecorderTraceListener class that writes to the specified file.
        // Parameters:
        //   fileName: The name of the file to receive the output.
        // Exceptions: T:System.ArgumentNullException: fileName is null.
        public RecorderTraceListener(string fileName) : base() { Init(); }

        // Summary: Initializes a new instance of the EkipCommon.RecorderTraceListener
        ...
        // Exceptions: T:System.ArgumentNullException: stream is null.
        public RecorderTraceListener(Stream stream, string name) { Init(); }
        ...
        //     writer is null.
        public RecorderTraceListener(TextWriter writer, string name) { Init(); }
        ...
        //   T:System.ArgumentNullException:
        //     fileName is null.
        public RecorderTraceListener(string fileName, string name) { Init(); }
        #endregion
        ...
        public IList<TraceEntry> GetItems()
        {
            return this.TraceEntries.ToList();
        }
        public IList<TraceEntry> Clear()
        {
            var oldItems = this.TraceEntries;
            this.TraceEntries = new ConcurrentQueue<TraceEntry>();
        ...
        public override void Write(object o)
        {
            ...
            var a = entries.OfTypeChecked<object>().ForEach(e =>
            {
                ...
                // EventLog.WriteEntry(_assembly.GetName().Name, message, trace2EventlogEntryType(entry.TraceEventType));
